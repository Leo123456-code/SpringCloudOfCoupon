...
public class HealthCheck {
     ...
     * 通过网关
     * localhost:9000/imooc/coupon-template/health
     *
     * @return
     */
    @GetMapping("/health")
     ...
     *      * 通过网关
     *      * localhost:9000/imooc/coupon-template/exception
     */
     ...
     *      * 通过网关
     *      * localhost:9000/coupon-gateway/imooc/coupon-template/info
     * @return
     */
    @GetMapping("/info")
    public List<Map<String,Object>> info(){
      ...
      /**
           ...
           * 获取微服务每个服务的实例信息
          * 适用于 服务集群化
       * localhost:7001/coupon-template/infoToMy
       *      * 通过网关
       *      * localhost:9000/imooc/coupon-template/infoToMy
          * @return
           */
    @GetMapping("/infoToMy")
